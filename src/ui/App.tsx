...
export default function App(){
 ...
 const board=<ChessBoard position={game.position} selected={selected} highlights={highlights} onSquareClick={click} orientation={orientation} renderPiece={s=>{const pc=game.position.board[s];return pc?<Piece piece={pc}/>:null;}}/>;
